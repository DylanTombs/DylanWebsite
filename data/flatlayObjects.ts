...
export const FLATLAY_OBJECTS: readonly FlatlayObjectDef[] = [
  {
    ...
    width: "8.5%",
    rotation: 1,
    mobile: { top: "28.0%", left: "5.5%", width: "19.0%", rotation: 0 },
    label: "Contact",
    panelTitle: "Contact.",
  ...
  },
  {
    ...
    width: "21.7%",
    rotation: 0,
    mobile: { top: "23.6%", left: "26.0%", width: "42.5%", rotation: 0 },
    label: "About",
    panelTitle: "About.",
  ...
  },
  {
    ...
    width: "25.1%",
    rotation: -90,
    mobile: { top: "28.9%", left: "59.5%", width: "42.8%", rotation: -90 },
    label: "Projects",
    panelTitle: "Projects.",
  ...
  },
  {
    ...
    width: "9.8%",
    rotation: 0,
    mobile: { top: "56.3%", left: "66.7%", width: "19.2%", rotation: 0 },
    label: "Skills",
    panelTitle: "Skills.",
  ...
  },
  {
    ...
    width: "11.4%",
    rotation: 0,
    mobile: { top: "55.9%", left: "31.3%", width: "25.4%", rotation: 0 },
    label: "Experience",
  ...
  },
  {
    ...
    width: "7.9%",
    rotation: 0.4,
    mobile: { top: "47.2%", left: "6.0%", width: "18.0%", rotation: 0 },
    label: "Education",
  ...
  },
  {
    ...
    width: "17.6%",
    rotation: -0.1,
    mobile: { top: "46.4%", left: "29.4%", width: "40.3%", rotation: 0 },
    label: "Achievements",
